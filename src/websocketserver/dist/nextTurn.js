...
function nextTurn(roomId, currentTurn, currentPlayerIndex, gameNumber) {
    var _a;
    ...
    if (guessIsInCorrect) {
        ...
        console.log(`Player ${(_a = room.players[currentPlayerIndex]) === null || _a === void 0 ? void 0 : _a.userId} was eliminated in room ${roomId} at turn ${currentTurn}.`);
